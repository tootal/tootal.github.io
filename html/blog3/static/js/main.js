...
function markdownRender(){
	var markdown_src=document.getElementById('content-markdown-src');
	var markdown_show=document.getElementById('content-markdown-show');
	markdown_show.innerHTML=marked(markdown_src.innerText);
}